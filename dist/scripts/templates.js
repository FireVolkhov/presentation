angular.module('App').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('app/slides/3.html',
    "<div ng-controller=\"slide3Ctrl\"><div class=\"b-slide-header\"><div class=\"b-slide-number\">03</div><div class=\"b-slide-title\">Производительность</div></div><div class=\"b-slide-content\"><div class=\"b-table\"><div class=\"b-table-row b-table-row--header\"><div class=\"b-table-col\"></div><div class=\"b-table-col\">Chrome</div><div class=\"b-table-col\">FF</div><div class=\"b-table-col\">Safari</div><div class=\"b-table-col\">IE 11</div><div class=\"b-table-col\">IE 10</div></div><div class=\"b-table-row\"><div class=\"b-table-col\">Рендеринг страницы на Angular</div><div class=\"b-table-col b-table-col--content\">9 225</div><div class=\"b-table-col b-table-col--content\">2 330</div><div class=\"b-table-col b-table-col--content\">3 152</div><div class=\"b-table-col b-table-col--content\">11 567</div><div class=\"b-table-col b-table-col--content\">9 392</div></div><div class=\"b-table-row\"><div class=\"b-table-col\">Рендеринг на Canvas</div><div class=\"b-table-col b-table-col--content\">91</div><div class=\"b-table-col b-table-col--content\">506</div><div class=\"b-table-col b-table-col--content\">103</div><div class=\"b-table-col b-table-col--content\">184</div><div class=\"b-table-col b-table-col--content\">167</div></div></div><div ng-click=\"test()\" class=\"b-test-button\">Потестить</div><div id=\"test-target\"></div></div></div>"
  );
